...
#/bin/cp ${HOME}/services/database/selfmanaged/mariadb/live/mariadb.config /etc/mysql/my.cnf
#/bin/sed -i "s/XXXXDB_PORTXXXX/${DB_PORT}/g" /etc/mysql/my.cnf

/bin/cat ${HOME}/services/database/selfmanaged/mariadb/live/mariadb.config >> /etc/mysql/my.cnf
/bin/sed -i "s/XXXXDB_PORTXXXX/${DB_PORT}/g" /etc/mysql/my.cnf
