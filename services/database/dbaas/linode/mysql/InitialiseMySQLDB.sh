...
/bin/cp ${HOME}/services/database/dbaas/linode/mysql/live/mysql-user.sql ${HOME}/runtime/mysql-init/initialiseDB-user.sql
/bin/cp ${HOME}/services/database/dbaas/linode/mysql/live/mysql-db.sql ${HOME}/runtime/mysql-init/initialiseDB.sql
...
${HOME}/utilities/remote/ConnectToMySQLDB.sh "dbaas-init" "no" "no" < ${HOME}/runtime/mysql-init/initialiseDB-user.sql
${HOME}/utilities/remote/ConnectToMySQLDB.sh "dbaas-init" "no" "no" < ${HOME}/runtime/mysql-init/initialiseDB.sql
