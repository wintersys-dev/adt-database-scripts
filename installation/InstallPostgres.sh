...
then
	${HOME}/services/email/SendEmail.sh "INSTALLATION ERROR POSTGRES SERVER" "I believe that postgres server hasn't installed correctly, please investigate" "ERROR"
else
