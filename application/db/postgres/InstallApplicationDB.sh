...
err_file="postgres_err_`/bin/date | /bin/sed 's/ //g'`"
...
then
	${HOME}/services/email/SendEmail.sh "DATABASE INSTALLATION HAS COMPLETED" "An application has been installed in your postgres database" "INFO"
